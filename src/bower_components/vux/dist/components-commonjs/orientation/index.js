module.exports = function(modules) {
    ...
    exports.default = {
        bind: function bind() {
            ...
            var _value = value.toString()[0].toUpperCase() + value.toString().slice(1);
            if (_orientation2.default["is" + _value]()) {
                this.el.style.display = "block";
            } else {
                this.el.style.display = "none";
            }
            _orientation2.default.change(function(e) {
                var info = _orientation2.default.getInfo();
    ...
    Orientation.prototype = {
        ...
        change: function change(fn, after) {
            if ((typeof fn === "undefined" ? "undefined" : (0, _typeof3.default)(fn)) === FUNCTION) {
                this._subs[after ? AFTER : ON].push(fn);
            }
            return this;
        },
        _fireChange: function _fireChange(e) {
            var self = this;
        ...
        _checkChange: function _checkChange(e) {
            var self = this;
            if (self._cfg.delay) {
        ...
        _onWinOrientationChange: function _onWinOrientationChange(e) {
            if (e.type === RESIZE) {
                this._fireChange(e);
            } else {
                this._checkChange(e);
    ...
    exports.default = Orientation.prototype.create();
}, function(module, exports, __webpack_require__) {
    module.exports = {
