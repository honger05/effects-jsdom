module.exports = function(modules) {
    ...
    exports.default = {
        ...
        ready: function ready() {
            ...
            var total = this.fillMode ? this.options.length + 1 : this.options.length;
            if (this.max) {
                if (this.max > total) {
                    this.max = total;
                }
